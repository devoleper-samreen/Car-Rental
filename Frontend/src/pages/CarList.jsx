...
function CarList() {
  ...
  const bookNow = async () => {
    if (
      !pickupDropoffData.pickupLocation ||
      !pickupDropoffData.dropoffLocation ||
      ...
      >
        {selectedCar && (
          <>
            ...
            <PickupDropoffForm
              onChange={(data) => setPickupDropoffData(data)}
            />
            <div className="mt-4">
              <h3 className="text-lg font-semibold">Total Days:</h3>
              <p className="text-xl font-bold">
                {calculateTotalDaysAndPrice().totalDays}
              </p>
            </div>
            ...
            <div className="mt-4">
              ...
              <p className="text-xl font-bold">
                ₹{calculateTotalDaysAndPrice().totalPrice}
              </p>
            </div>
            <Button
              type="primary"
