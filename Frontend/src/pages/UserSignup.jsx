            ...
            <div className="bg-white p-8 rounded-2xl w-[400px]">
                ...
                <form className="space-y-4">
                    <div className="flex items-center bg-gray-100 rounded px-3 py-2">
                        ...
                        <input type="text" placeholder="Full Name" className="bg-transparent w-full outline-none" />
                    </div>
                    <div className="flex items-center bg-gray-100 rounded px-3 py-2">
                        <FaPhone className="text-gray-400 mr-3" />
                        <input type="tel" placeholder="Phone Number" className="bg-transparent w-full outline-none" />
                    </div>
                    <div className="flex items-center bg-gray-100 rounded px-3 py-2">
                    ...
                    <button className="w-full bg-indigo-600 text-white py-2 rounded-md hover:bg-indigo-700 transition cursor-pointer">Sign Up</button>
                </form>
